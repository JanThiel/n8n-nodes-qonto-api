...
export const clientsOperations: INodeProperties[] = [
...

	{
		...
		options: [
			{ name: 'Create a Client', value: 'createClient', action: 'Create a client' },
			{ name: 'Delete a Client', value: 'deleteClient', action: 'Delete a client' },
			{ name: 'Get a List of Clients', value: 'getListClients', action: 'Get a list of client' },
			{
				name: 'Get Clients Details',
				value: 'getClientDetails',
				action: 'Get clients details',
			},
			{ name: 'Update a Client', value: 'updateClient', action: 'Update a client' },
		],
	...
	// ------------------------
	{
		...
		displayOptions: {
			show: {
				resource: ['clients'],
				operation: ['getClientDetails', 'deleteClient'],
			},
		},
		default: '',
		required: true,
	...
	},
	{
		...
		options: [
			...
			},
			{
				...
				default: '',
				description:
					'Filter clients by name (exact and partial matches, case-insensitive). Must be at least 2 characters.',
			},
			{
				displayName: 'Sort By',
				name: 'sort_by',
