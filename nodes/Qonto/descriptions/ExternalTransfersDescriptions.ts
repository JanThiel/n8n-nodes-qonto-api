...
export const externalTransfersOperations: INodeProperties[] = [
	...
	// ------------------------
	{
		...
		displayOptions: {
			show: {
				resource: ['externalTransfers'],
				operation: ['showAnExternalTransfer'],
			},
		},
	...
	// ------------------------
	{
		...
		displayOptions: {
			show: {
				resource: ['externalTransfers'],
				operation: ['listExternalTransfers'],
			},
		},
	},
	{
	...
	},
	{
		...
		options: [
			...
			},
			{
				...
				default: '',
				description:
					'Filter by the Recurring Transfer that created them (comma-separated list of UUIDs)',
			},
			{
	...
	// ------------------------
	{
		...
		displayOptions: {
			show: {
				resource: ['externalTransfers'],
				operation: ['createAnExternalTransfer'],
			},
		},
		default: '',
		description:
				...
				values: [
					{
						...
						default: '',
						description:
							'Name of the binary property containing the data to be added to the transaction as an attachment. Multiple properties can be set separated by comma.',
					},
				],
			},
		],
	...
	// ------------------------
	{
		...
		displayOptions: {
			show: {
				resource: ['externalTransfers'],
				operation: ['createExternalTransfersWithCreditorData'],
			},
		},
		default: '',
		description: 'IBAN of account to debit',
